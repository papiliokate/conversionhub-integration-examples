...
var t = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), n = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
})))(), o = ({ siteKey: t = "ch_pub_demo_testkey_12345", onHumanVerified: n, gameUrl: r = "https://conversion.business/sunny-day-maze/", className: i = "conversion-business-widget", style: o = {} }) => {
	let s = !t || t === "ch_pub_demo_testkey_12345";
	return e(() => {
		if (typeof window > "u") return;
		s && console.error("Conversion.Business Error: Invalid Site Key. Please register at https://conversion.business to obtain a valid API key.");
		let e = (e) => {
			e.data && e.data.type === "oops_captcha_solved" && n && e.data.payload && n(e.data.payload);
		};
		...
		className: i,
		children: [
			/* @__PURE__ */ (0, a.jsx)("strong", { children: "Widget Error:" }),
	...
	}) : /* @__PURE__ */ (0, a.jsx)("iframe", {
		className: i,
		src: `${r}?mode=captcha&clientId=${t}`,
		style: {
			width: "100%",
			height: "400px",
			border: "none",
